(function(){
  ...
  angular
    .module('app.encuesta')
    .factory('encuestaService', encuestaService);

  encuestaService.$inject = ['$q', '$http', '$timeout', 'HOST'];

  function encuestaService($q, $http, $timeout, HOST) {
    
    return {
      enviarEncuesta : function(data) {
        return httpRequest('POST','encuesta/saveEncuesta',data);
      }
    };
